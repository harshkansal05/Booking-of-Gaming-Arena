...
<html>
<head>
<title>Recreational Room and Sports Arena Portal | Hostel ::</title>
		...
		<!--rooms-->
			<div class="content">
					<div class="room-section">
						<div class="container">
						<h2>Total Availability Details</h2>
...
{               ?>
							<div class="room1">
								...
								<div class="col-md-7 room-grid1">
									...
									<p>Max people : <?php  echo htmlentities($row->MaxAdult);?></p>
									
									<p>No of Tables/Courts : <?php  echo htmlentities($row->NoofBed);?></p>
									<p>Game Facilities : <?php  echo htmlentities($row->RoomFacility);?></p>
									<p>Booking Price : <?php  echo htmlentities($row->Price);?></p>
