...
<html>
<head>
<title>Recreational Room and Sports Arena Portal | Hostel :: Book Room</title>
...
{               ?>
								...
								<select  type="text" value="" class="form-control" name="idtype" required="true" class="form-control">
									...
									<option value="MUJ ID">MUJ ID</option>
								...
								<h5>Time Slot </h5>								
								<h5>Start time </h5>
								<input  type="time" value="" class="form-control" name="checkintime" required="true">
								<h5>End time </h5>
								<input  type="time" value="" class="form-control" name="checkouttime" required="true">
